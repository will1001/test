...
export const GALLERY_DATA = {
  ...
  text: "Pemasangan Instalasi Baru Atau Penambahan Instalasi Listrik, Perapihan Jaringan Instalasi Listrik, Memperbaiki Jaringan Instalasi Listrik Yang Bermasalah Seperti Adanya Arus Pendek / Konsleting Dan Sejenisnya, Perakitan Panel Listrik / Box MCB Pemecah Arus Atau Grouping Jaringan Instalasi Listrik, Pemasangan Segala Jenis Armatur / Aksesoris Listrik Seperti Stop Kontak Atau Saklar, Lampu Hias Gantung, Pemasangan Lampu Taman,Dan Lain Lain, Memperbaiki MCB Yang Sering Turun Dan Sebagainya.",
};
